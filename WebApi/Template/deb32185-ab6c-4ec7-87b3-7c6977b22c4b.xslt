  ...
  7
                  ...
                  Tiền Thuế GTGT
                      ...
                      Đơn giá
                                    ...
                                    <td width="13%;border-bottom:1px solid black" style="border: 1px solid black">
                                        <span style="font-size: 12pt">
                                            <b>
                                            ...
                                            <xsl:when test="count(DLHDon/NDHDon/DSHHDVu/HHDVu) &lt; 11" >
                                                <xsl:for-each select="DLHDon/NDHDon/DSHHDVu/HHDVu">
                                                    <tr style="height:25px;border-top: none!important;border-bottom:1px dotted gray;">
                                                        ...
                                                        <td style="width:27%;text-align:left;border-right:1px solid black;padding-left:3px">
...
<xsl:with-param name="text" select="THHDVu"/>
                                                        ...
                                                        <td width="8%" style="border-right:1px solid black;text-align:right">
                                                         ...
                                                         <td width="13%" style="border-right:1px solid #1A4780;text-align:right">
                                                         <xsl:if test="TSuat='10%'"> <xsl:value-of select="format-number(ThTien + (ThTien*0.1), '#.###','vnd')" /></xsl:if>
                                                            <xsl:if test="TSuat='8%'"> <xsl:value-of select="format-number(ThTien + (ThTien*0.08), '#.###','vnd')" /></xsl:if>
                                                            <xsl:if test="TSuat='5%'"> <xsl:value-of select="format-number(ThTien + (ThTien*0.05), '#.###','vnd')" /></xsl:if>
                                                            <xsl:if test="TSuat='0%'"> <xsl:value-of select="format-number(ThTien, '#.###','vnd')" /></xsl:if>
                                                            <xsl:if test="TSuat='KCT'"> <xsl:value-of select="format-number(ThTien, '#.###','vnd')" /></xsl:if>
                                                            <xsl:if test="TSuat='KKKNT'"> <xsl:value-of select="format-number(ThTien, '#.###','vnd')" /></xsl:if></td>
                                    ...
                                    <xsl:when test="$soHHdu &gt; 0">
                                        <xsl:for-each select="(//node())[$soHHdu >= position()]">
                                            <tr style="height:25px;border-top: none!important;border-bottom:1px dotted gray;">
                                                ...
                                                <td style="width:27%;text-align:left;border-right:1px solid black;padding-left:3px"></td>
