          ...
          @page {
            ...
            <page size="A4">
                <body style="font-family:Times New Roman">
                    <div style="viewstyle;border:none;background-color: hsla(0,0%,100%,0.80);background-size: 80%;background-position: center;">
  ...
  7
                  ...
                  Đơn vị bán hàng
                    ...
                    Địa chỉ
                                ...
                                <tr>
                                    <td style="padding-left:20px;color:white">
                    Địa chỉ
                                   :
                                </td>
                                    <td>
                                   168 Trần Hưng Đạo, Phường Cầu Ông Lãnh, Thành phố Hồ Chí Minh, Việt Nam
                                </td>
                                </tr>
                                <tr>
                                    <td style="padding-left:20px;">
                    ...
                    &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
                                ...
                                <!-- <tr>
                                    <td style="padding-left:20px;">Đồng tiền thanh toán:</td>
                                    <td>
...
Hoa don chua phat hanh
                            ...
                            <div style="width:100%;text-align:center;font-size:11.5pt;display:param2_2">param2</div>
                      ...
                      Tiền thuế
                            ...
                            <table style="width:100%;text-align:left;border-left:1px solid black;border-top:1px solid black;font-size:11pt;border-right:1px solid black;font-size:11pt">
                                <tr style="border:1px solid black">
                                    <td style="border-right:1px solid none;text-align:left"> Tổng tiền chưa có thuế GTGT:</td>
                                    <td style="border-right:1px solid black;text-align:right">
                                        <xsl:value-of   select="format-number(DLHDon/NDHDon/TToan/TgTCThue, '#.###','vnd')"/>
                                    </td>
                                </tr>
                                <tr style="border:1px solid black">
                                    <td style="border-right:1px solid none;text-align:left"> Tổng thuế 0%:</td>
                                    <td style="border-right:1px solid black;text-align:right">
                                ...
                                <tr style="border:1px solid black">
                                    <td style="border-right:1px solid none;text-align:left"> Tổng thuế 5%:</td>
                                    <td style="border-right:1px solid black;text-align:right">
                                        <xsl:for-each select="DLHDon/NDHDon/TToan/THTTLTSuat/LTSuat">
                                            <xsl:if test="TSuat='5%'">
                                                <xsl:value-of   select="format-number(TThue, '#.###','vnd')"/>
                                ...
                                <tr style="border:1px solid black">
                                    <td style="border-right:1px solid none;text-align:left"> Tổng thuế 8%:</td>
                                    <td style="border-right:1px solid black;text-align:right">
                                        <xsl:for-each select="DLHDon/NDHDon/TToan/THTTLTSuat/LTSuat">
                                            <xsl:if test="TSuat='8%'">
                                                <xsl:value-of   select="format-number(TThue, '#.###','vnd')"/>
                                ...
                                <tr style="border:1px solid black">
                                    <td style="border-right:1px solid none;text-align:left"> Tổng thuế 10%:</td>
                                    <td style="border-right:1px solid black;text-align:right">
                                        <xsl:for-each select="DLHDon/NDHDon/TToan/THTTLTSuat/LTSuat">
                                ...
                                <xsl:if test="DLHDon/NDHDon/TToan/THTTLTSuat/LTSuat/TSuat='KHAC:3.5%'">
                                    <tr style="border:1px solid black">
                                        <td style="border-right:1px solid none;text-align:left"> Tổng thuế
    ...
    :
     ...
     :
                                ...
                                <tr style="border:1px solid black">
                                    <td style="border-right:1px solid none;text-align:left">Tổng tiền thuế giá trị gia tăng :</td>
                                    <td style="border-right:1px solid black;text-align:right">
                                        <xsl:choose>
                                            <xsl:when test="TSuat='\'">
                                                <xsl:value-of select="'\'"/>
                                ...
                                <xsl:for-each select="DLHDon/NDHDon/TToan">
                                    <xsl:if test="TTCKTMai!=''">
                                        <tr style="border:1px solid black">
                                            <td style="border-right:1px solid none;text-align:left">Tổng tiền chiết khấu thương mại :</td>
                                            <td style="border-right:1px solid black;text-align:right">
                                                <xsl:choose>
                                                    <xsl:when test="TSuat='\'">
                                                        <xsl:value-of select="'\'"/>
                                                    ...
                                                    <xsl:otherwise>
                                                        <xsl:choose>
                                                            ...
                                                            <xsl:otherwise>
                                                                <xsl:value-of   select="format-number(TTCKTMai, '#.###','vnd')"/>
                                                            </xsl:otherwise>
                                                        </xsl:choose>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                ...
                                <tr style="border:1px solid black;font-weight:bold">
                                    <td style="border-right:1px solid nonek;text-align:left">Tổng cộng tiền thanh toán 
:</td>
                                    <td style="border-right:1px solid black;text-align:right">
