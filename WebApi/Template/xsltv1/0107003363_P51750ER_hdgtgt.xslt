...
<xsl:stylesheet version="1.0"
    ...
    <xsl:param name="paramlien" select="'0'" />
...
<xsl:variable name="Ten" select=" DLHDon/NDHDon/NMua/Ten" /> <xsl:variable name="HVTNMHang1" select=" DLHDon/NDHDon/NMua/HVTNMHang" /> 
              ...
              MẪU
                  ...
                  Đơn vị bán hàng
                    ...
                    Số tài khoản
                                ...
                                <td>
                                    <xsl:value-of select="DLHDon/NDHDon/NBan/STKNHang" /> <xsl:choose>
                                        <xsl:when test="$STKNHangNBan=$STKNHangNBan1"></xsl:when>
                                        <xsl:otherwise><xsl:value-of select="$STKNHangNBan" /></xsl:otherwise>
                                    </xsl:choose>
                    Tại:
                                    <xsl:value-of select="DLHDon/NDHDon/NBan/TNHang" /> <xsl:choose>
                                        <xsl:when test="$TNHangNBan=$TNHangNBan1"></xsl:when>
                                        <xsl:otherwise><xsl:value-of select="$TNHangNBan" /></xsl:otherwise>
                                    </xsl:choose>
                                </td>
                            </tr>
                            <tr>
...
<xsl:choose> <xsl:when test="$HVTNMHang1=$HVTNMHang"></xsl:when> <xsl:otherwise> <xsl:value-of select="$HVTNMHang" /></xsl:otherwise> </xsl:choose> 

<xsl:choose> <xsl:when test="$HVTNMHang1=$TenNMHCNhan"></xsl:when> <xsl:otherwise> <xsl:value-of select="$TenNMHCNhan" /></xsl:otherwise> </xsl:choose>
&#160;&#160;&#160;  &#160;&#160;&#160;  &#160;&#160;&#160;  &#160;&#160;&#160;<xsl:if test="DLHDon/NDHDon/NMua/CCCDan!=''">Căn cước công dân <i>(Citizen ID No.)</i>:  <xsl:value-of select="DLHDon/NDHDon/NMua/CCCDan" /> </xsl:if>
                            ...
                            <tr>
                                ...
                                <td>
									...
									<xsl:choose>
										<xsl:when test="$HVTNMHang=$Ten"></xsl:when>
										<xsl:otherwise>
											
										<xsl:choose>
											<xsl:when test="$TenNMHCNhan=$Ten"></xsl:when>
											<xsl:otherwise>
                    ...
                    Số tài khoản
                                ...
                                <td>
                                    <xsl:value-of select="DLHDon/NDHDon/NMua/STKNHang" />
										...
										<xsl:choose>
										 <xsl:when test="TTruong='STKNHang'"><xsl:value-of   select="DLieu"/></xsl:when>
										 <xsl:otherwise>
                    ...
                    Tại:
                                    <xsl:value-of select="DLHDon/NDHDon/NMua/TNHang" />
                                                                        									<xsl:for-each select="DLHDon/NDHDon/NMua/TTKhac/TTin">
										<xsl:choose>
										 <xsl:when test="TTruong='TNHang'"><xsl:value-of   select="DLieu"/></xsl:when>
										 <xsl:otherwise>
...
)</i>:</td> <td><xsl:value-of select="DLHDon/TTChung/DVTTe" /></td></tr>
<xsl:if test="DLHDon/TTChung/TGia !=''"><tr>
									<td style="padding-left:20px;">
										Tỷ giá::
									</td>
									<td>
...
<xsl:if test="DLHDon/NDHDon/NMua/MDVQHNSach!=''"><tr>
									<td style="padding-left:20px;">
										Mã ĐVQHNS <i>
											(Book Bank
											)</i>:
