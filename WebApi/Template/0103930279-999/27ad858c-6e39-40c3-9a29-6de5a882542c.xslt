...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="HDon">
        ...
        <html lang="en"
            ...
            <div size="A4" style="width:21cm;min-height:29.7cm;font-family:Times New Roman;padding:10px">
            ...
            <div id="header" style="display:flex;flex-direction:paramOpacityHeaderFlexDirection;padding-right:10px">
                <div id="header_left" style="width:200px;display:flex;justify-content:center">
                    <img style="height:80px;align-content:center;position:static;left:0;top:0;object-fit: scale-down;padding-top:5px"
                ...
                <div id="header_right;" style="padding-top:5px">  
                ...
                <tr>
                  <td style="padding-left:10px;" >
                    Đơn vị bán hàng :
                   <span style="font-weight:bold; font-size:14pt;color:red">
                   <xsl:value-of select="inv:invoiceData/inv:sellerLegalName" /> </span> 
                ...
                <tr>
                  <td style="padding-left:10px;">                    
                    Mã số thuế :
                     ...
                     <span style="font-weight:bold; font-size:12pt;color:red">
                      <du><xsl:value-of select="inv:invoiceData/inv:sellerTaxCode" /> </du>
                    </span>
                  </td>
                </tr>
                <tr>
                  <td style="padding-left:10px;">
                    Địa chỉ :
                     ...
                     <xsl:value-of select="inv:invoiceData/inv:sellerAddressLine" />
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  Email:
                    ...
                    info@romanaresort.com.vn  &#160;&#160;&#160;  &#160;&#160;&#160;  &#160;&#160;&#160;  &#160;&#160;&#160;  &#160;&#160;&#160;  &#160;&#160;&#160;  &#160;&#160;&#160;
                    Website:  www.romanaresort.com.vn
                  </td>

                </tr>
				</table>
				  <table style="width:100%;line-height:20px;font-size:12pt">
				<tr>
                  <td style="padding-left:10px;width:15%;padding-top:5px">
                    <span style="top:5px;position:relative"> Điện thoại :</span>
                 
                    
                  
                  </td>
				  <td style="border-bottom:1px dotted black;width:70%"><xsl:value-of select="inv:invoiceData/inv:sellerPhoneNumber" /></td>
				  <td style="width:15%"></td>
                </tr></table>
				  <table style="width:100%;line-height:22px;font-size:12pt">
                <tr>
                  <td style="padding-left:10px;width:22%;padding-top:5px">
                    <span style="top:5px;position:relative"> Số tài khoản :</span>
                  

                  </td>
				    <td style="border-bottom:1px dotted black;width:63%">
					                    <xsl:value-of select="inv:invoiceData/inv:sellerBankAccount" />
                    Tại: <xsl:value-of select="inv:invoiceData/inv:sellerBankName" />
					</td>
           
<td style="width:15%"></td>
                </tr>
              </table> -->
                            <table style="width:100%;line-height:25px;font-size:13pt">
                                <tr>
                                ...
                                <tr>
                                    <td style="padding-left:20px;width:16%">                    
                    Mã số thuế :
                  </td>
                                    <td style="width:84%">
                    ...
                    Tại:
                            ...
                            <hr style="background-color:black;width:100%;height:0.5px;margin-bottom:2px;margin-top:1px" />
                            <table style="width: 100%;font-size:13pt" class="textfont">
                                <tr style="height:27px">
                                    <td style="width:26%;padding-left:10px;padding-top:5px">
                                        <span style="top:5px;position:relative">
                  Họ tên người mua hàng :   
                </span>
                                    </td>
                                    <td style="border-bottom: 1px dotted black; width:74%">
                                        <xsl:value-of select="DLHDon/NDHDon/NMua/HVTNMHang" />
                                        <xsl:for-each select="DLHDon/NDHDon/NMua/TTKhac/TTin">
                                            <xsl:choose>
                                             <xsl:when test="TTruong='HVTNMHang'"><xsl:value-of   select="DLieu"/></xsl:when>
                            ...
                            <table style="width: 100%;font-size:13pt" class="textfont">
                                <tr style="height:27px">
                                    <td style="padding-left:10px;padding-top:5px;width:15%">
                                        <span style="top:5px;position:relative">
                  Tên đơn vị :
                </span>
                                    </td>
                                    <td style="border-bottom: 1px dotted black;width:85%">
                  ...
                  Địa chỉ :
                            ...
                            <table style="width:100%;font-size:13pt" class="textfont">
                                <tr style="height:27px">
                                    <td  style="width:25%;padding-left:10px;padding-top:5px">
                                        <span style="top:5px;position:relative">
                  Hình thức thanh toán :   
                </span>
                                    </td>
                                    <td  style="border-bottom: 1px dotted black; width:25%">
                                        <xsl:value-of select="DLHDon/TTChung/HTTToan" />
                                    </td>
                                    <td  style="width:15%;padding-left:10px;padding-top:5px">
                                        <span style="top:5px;position:relative">
                    Số tài khoản :
                  </span>
                                    </td>
                                    <td  style="border-bottom: 1px dotted black;width:35%;text-align:left">
                      ...
                      Thành tiền
                          ...
                          Thuế suất GTGT(%)
                            ...
                            <table style="width:100%;text-align:center; font-size:11pt;border: 1px solid black;paramTableBG; color:black;word-break: break-word;" > -->
                                <xsl:variable name="lien" select="1" />
                                <xsl:choose>
...
Total value added tax)</i>:
                                        ...
                                        <xsl:otherwise>
                                            <table style="width: 100%; border: 1px solid black" class="textfont">
                                                <tr style="height: 30px; border-bottom: 1px solid black">
                                                    ...
                                                    <td style="width:10%;border-left: none!important; border-right: none"></td>
                                                    <td style="width:10%;border-left: none!important; border-right: none;text-align:right">
                      Cộng tiền hàng
                                               :
                                            </td>
												...
												:
                                                    ...
                                                    <td style="width:10%;border-left: none!important; border-right: none">
                     ...
                     Tiền thuế GTGT
                                               :
                                                ...
                                                <tr style="height: 30px; border-bottom: 1px solid black">
                                                    ...
                                                    <td style="width:30%;border-left: none!important; border-right: none;text-align:right">
                     Tổng cộng tiền thanh toán
                                               :
                                            </td>
                                                    <td style="width:10%;border-right: none!important;border-left: none;text-align:right">
                ...
                (Ký, ghi rõ họ tên)
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:right; padding-top: 5px; width: 30%;text-align:center;height:30px">
                    ...
                    Ngày ký:
                                ...
                                <tr>
                                    <td colspan="3" style="text-align: center; border: none; padding-top: 10px;">
