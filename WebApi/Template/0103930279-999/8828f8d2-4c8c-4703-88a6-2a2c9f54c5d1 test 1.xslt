                ...
                <body style="font-family:Times New Roman">
                    <div style="viewstyle;border:none;">
                        ...
                        <div style="border:2px solid black;width:100%;height: auto; min-height: 100%;background-image:url(paramVien);
                            ...
                            <div id="header" style="display:flex;flex-direction:paramOpacityHeaderFlexDirection;padding:10px">
                            ...
                            <div style="width:100%;display:paramfooter">
                                <div style="idparamTongtien">
                                    ...
                                    <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                            <table style="width: 100%; border: 1px solid black;font-size:12pt" class="textfont">
                                            ...
                                            <table style="width: 100%; border-left: 1px solid black;border-right: 1px solid black;font-size:12pt" class="textfont">
                                                <tr style="height: 30px; border-bottom: 1px solid black">
