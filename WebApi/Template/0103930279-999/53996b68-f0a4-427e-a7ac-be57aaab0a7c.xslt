							...
							<tr>
								...
								<td style="padding-top:5px;text-align:center;width:40% ">
                                    ...
                                    <span style="font-weight:bold; font-size:11pt;">
                                       <xsl:if test="DLHDon/TTChung/HDDCKPTQuan=1"> (Dành cho tổ chức, cá nhân trong khu phi thuế quan)</xsl:if>                                         
                                    </span> <br/>
  ...
  7
						...
						<table style="width: 100%;" class="textfont">
							<tr style="height:20px">
								<td style="width:35%;padding-left:10px;padding-top:12px">
						...
						<table style="width:100%" class="textfont">
							<tr>
								<td  style="width:35%;padding-left:10px;padding-top:15px">
						...
						<table style="width: 100%;" class="textfont">
							<tr style="height:20px">
								<td style="width:35%;padding-left:10px;padding-top:12px">
									Đồng tiền thanh toán <i>(Payment Currency)</i>:
                                </td>
								<td style="border-bottom: 1px dotted black">
