						...
						<div style="border:2px solid black;width:100%;height: auto; min-height: 100%;background-image:url(paramVien);
							...
							<div id="header" style="display:flex;flex-direction:paramOpacityHeaderFlexDirection;padding-top:10px;padding-right:10px">
								...
								<div id="header_center" style="flex:1;text-align:center">
									...
									<xsl:if test="DLHDon/TTChung/TTHDLQuan/TCHDon=1">
										<br/>
										<span style="font-size:12pt">(Hoá đơn thay thế)</span>
									</xsl:if>
									<xsl:if test="DLHDon/TTChung/TTHDLQuan/TCHDon=2">
										<br/>
										<span style="font-size:12pt">(Hoá đơn điều chỉnh)</span>
									</xsl:if>
									<br/>
							...
							<table style="width:100%;line-height:25px;font-size:12pt">
								...
								<tr style="dien_thoai_css_display;">
									...
									<td style="dien_thoai_css;">
										...
										&#160;&#160;&#160;  &#160;&#160;&#160;  &#160;&#160;&#160;
										<xsl:choose>
											<xsl:when test="DLHDon/NDHDon/NBan/Fax!=''">
												Fax:
							...
							<table style="width:100%;line-height:25px">
								<xsl:if test="$TenTau!=''">
									<tr>
										...
										<td>
											<xsl:value-of select="$TenTau" />
										</td>
									</tr>
								</xsl:if>
								<xsl:if test="$SoThamChieu!=''">
									<tr>
										<td style="padding-left:20px;width:35%">
										...
										<td>
											<xsl:value-of select="$SoThamChieu" />
										</td>
									</tr>
								</xsl:if>
								<xsl:if test="$NgayDenNgayDi!=''">
									<tr>
										<td style="padding-left:20px;width:35%">
										...
										<td>
											<xsl:value-of select="$NgayDenNgayDi" />
										</td>
									</tr>
								</xsl:if>
								<xsl:if test="$NoiDiNoiDen!=''">
									<tr>
										<td style="padding-left:20px;width:35%">
										...
										<td>
											<xsl:value-of select="$NoiDiNoiDen" />
										</td>
									</tr>
								</xsl:if>
							</table>
								...
								<tr>
									...
									<td style="text-align:right;  height:80px; width: 30%;text-align:center;">
									 ...
									 <!-- <xsl:choose>
										...
										<xsl:when test="DSCKS/NBan/ds:Signature">
