            ...
            <div size="A4" style="width:21cm;min-height:29.7cm;font-family:Times New Roman">
                <body style="font-family:Times New Roman">
                    <div style="viewstyle;border:none;">
                        ...
                        <!-- <div style="width:100%;height: auto; min-height: 100%;background-image:url(paramVien);background-clip: padding-box;background-size:cover;background-repeat:round;padding:20px;z-index:1;border-color:white"> -->
                        <div style="width:100%;height: auto; min-height: 100%;padding:20px">
                            ...
                            <table style="width:100%;line-height:25px;font-size:12pt">
                                <tr style="ten_cong_ty_css_display;">
                                    ...
                                    <td style="padding-left:0px;width:75%;ten_cong_ty_css;" colspan="2">
