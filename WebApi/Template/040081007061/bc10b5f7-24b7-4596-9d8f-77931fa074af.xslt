...
<xsl:variable name="TNHangNBan" select="DLHDon/NDHDon/NBan/TTKhac/TTin[TTruong='TNHang']/DLieu" />
		<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
			<head>
				...
				<style type="text/css">
					...
					@media print {
					/* Thiết lập cho class ngắt trang */
					.page-break {
					display: block;
					page-break-after: always; /* Luôn ngắt trang sau phần tử này */
					break-after: page;
					position: relative;
					}

					/* QUAN TRỌNG: Không ngắt trang nếu là trang cuối cùng để tránh trang trắng ở cuối */
					.page-break:last-child {
					page-break-after: auto;
					break-after: auto;
					}

					/* Ẩn các thành phần thừa khi in nếu cần */
                                ...
                                <div style="flex:1;text-align:left;">
                                    ...
                                    <tr style="mst_css_display;">
                                        <td style="padding-left:10px;width:150px;font-size:10pt;mst_css;">                    
                                            ...
                                            <span style="font-weight:bold; letter-spacing:5px"><xsl:value-of select="DLHDon/NDHDon/NBan/MST" /></span>
						...
						<table style="width:100%;line-height:25px;font-size:10pt;color:black">
                                <tr style="ho_ten_nguoi_mua_css_display;">
                                    ...
                                    <td style="width:62%;ho_ten_nguoi_mua_css;">
                                       <span style="color:black;font-size:10pt;"> <xsl:value-of select="DLHDon/NDHDon/NMua/HVTNMHang" /></span>
                                    </td>
                                ...
                                <tr style="don_vi_mua_hang_css_display;">
                                    ...
                                    <td style="don_vi_mua_hang_css;">
                                        <span style="color:black;font-size:10pt;"><xsl:value-of select="DLHDon/NDHDon/NMua/Ten" /></span>
                                    </td>
                                </tr>
                                <tr style="mst_nguoi_mua_css_display;">
                                    ...
                                    <td style="mst_nguoi_mua_css;">
                                        <span style="color:black;font-size:10pt;"> <xsl:value-of select="DLHDon/NDHDon/NMua/MST" /></span>
                                    </td>
                                </tr>
                                <tr style="dia_chi_nguoi_mua_css_display;">
                                    ...
                                    <td style="dia_chi_nguoi_mua_css;">
                                        <span style="color:black;font-size:10pt;"><xsl:value-of select="DLHDon/NDHDon/NMua/DChi" /></span>
                                    </td>
                                </tr>
                                <tr style="so_tai_khoan_nguoi_mua_css_display;">
                                    ...
                                    <td style="so_tai_khoan_nguoi_mua_css;">
                                        <span style="color:black;font-size:10pt;"> <xsl:value-of select="DLHDon/NDHDon/NMua/STKNHang" /> 
                                        Tại:
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span style="color:black;font-size:10pt;"><xsl:value-of select="DLHDon/TTChung/HTTToan" /></span>
                                        &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
                                        &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span style="color:black;font-size:10pt;"><xsl:value-of select="DLHDon/TTChung/DVTTe" /></span>&#160;&#160;&#160;&#160;
                                        <xsl:if test="DLHDon/TTChung/TGia !='0'">Tỷ giá:
                                            <span style="color:black;font-size:10pt;"><xsl:value-of select="format-number(DLHDon/TTChung/TGia, '#.###','vnd')" /></span>
                                        </xsl:if>
                                    </td>
                                </tr>
                            </table>
    ...
    <div style="width:100%;font-weight:bold;text-align:center;font-size:11.5pt">
        ...
        <xsl:value-of select="substring(
            concat('00000000', DLHDon/TTChung/TTHDLQuan/SHDCLQuan),
            string-length(concat('00000000', DLHDon/TTChung/TTHDLQuan/SHDCLQuan)) - 7
        )"/>, mẫu số
