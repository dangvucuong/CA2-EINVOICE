								...
								<table style="width: 100%; border-bottom: 1px solid black">
									<tr style="height: 30px; border-bottom: 1px solid black;border-left:1px solid black;border-right:1px solid black;font-size:10pt">
										...
										Cộng tiền bán hàng hóa, dịch vụ
											<xsl:if test="DLHDon/NDHDon/TToan/TTKhac/TTin/DLieu!=''">(
												<xsl:value-of select="substring-after(substring-before(DLHDon/NDHDon/TToan/TTKhac/TTin/DLieu, substring-before(substring-after(DLHDon/NDHDon/TToan/TTKhac/TTin/DLieu,'giảm'),'tương')),'|')" /> &#160;
												<xsl:value-of select="format-number(substring-before(DLHDon/NDHDon/TToan/TTKhac/TTin/DLieu,'|'), '#.###','vnd')" /> đồng &#160;
												<xsl:value-of select="substring-after(DLHDon/NDHDon/TToan/TTKhac/TTin/DLieu, substring-before(substring-after(DLHDon/NDHDon/TToan/TTKhac/TTin/DLieu,'giảm'),'tương'))" />)
											</xsl:if>:
										</td>
