...
<xsl:variable name="DLQRCode" select="//*[local-name() = 'DLQRCode']" />
		...
		/* THÊM ĐOẠN NÀY VÀO CUỐI PHẦN STYLE */
    @media print {
        .page-break { 
            page-break-after: always; 
            break-after: page;
            min-height: 100vh; /* Đảm bảo chiều cao full trang giấy nếu cần */
        }
    }
				</style>
			</head>
		...
		<div class="page-break" style="viewstyle;border:none; page-break-after: always;">
					...
					<div style="border:2px solid black;width:100%;height: auto; min-height: 100%;background-image:url(paramVien);
						 ...
						 <div id="header" style="display:flex;flex-direction:paramOpacityHeaderFlexDirection;padding-right:10px;padding-top:10px;">
                                ...
                                <div id="header_center" style="flex:1;text-align:center">
                                    ...
                                    <br/>
                                    <span style="font-weight:bold; font-size:15pt;font-style:italic">(SALES INVOICE)</span>
                                    <br/>
                                ...
                                <div id="header_right;font-size:10pt">   
                                    Mẫu số
                                    <i>(Form)</i>:
                                    <b>
                                    ...
                                    <br />
                                    <div style="color: red; font-size: 10pt;padding-top:0px;  display: normal;text-align:center">
						...
						<table style="width:100%;">
                            ...
                            <table style="width:100%;line-height:25px;font-size:12pt">
                                <tr style="ten_cong_ty_css_display;">
                                    <td style="width:100%;padding-left:10px;ten_cong_ty_css;" >
                                        Đơn vị bán hàng
                                        <i>(Seller)</i>:
                                    
                                        <span style="text-transform: uppercase;font-size:13pt;">
                                        <b><xsl:value-of select="DLHDon/NDHDon/NBan/Ten" /></b></span>
                                ...
                                <tr style="mst_css_display;">
                                    <td style="padding-left:10px;width:150px;mst_css;">                    
                                        Mã số thuế
                                        <i>(Tax code)</i>:
                                    
                                        <span style="letter-spacing:3px;font-weight:bold"><xsl:value-of select="DLHDon/NDHDon/NBan/MST" /></span>
                                        
                                    </td>
                                </tr>
                                <tr style="dia_chi_css_display;">
                                    <td style="padding-left:10px;width:150px;dia_chi_css;">
                                        Địa chỉ
                                        <i>(Address)</i>:
                                ...
                                <tr style="so_tai_khoan_css_display;">
                                    <td style="padding-left:10px;so_tai_khoan_css;">
                                        Số tài khoản
                                        <i>(Account No)</i>:
                                ...
                                <tr style="dien_thoai_css_display;">
                                    <td style="padding-left:10px;dien_thoai_css;">
                                        Điện thoại
                                        <i>(Tel)</i>:
                            ...
                            <table style="width:100%;line-height:25px;font-size:12pt">
                                <tr style="ho_ten_nguoi_mua_css_display;">
                                    <td style="padding-left:10px;ho_ten_nguoi_mua_css;">
                                ...
                                <tr style="don_vi_mua_hang_css_display;">
                                    <td style="padding-left:10px;don_vi_mua_hang_css;">
                                        Tên đơn vị
                                        <i>(Company's)</i>:
                                    
                                        <b><xsl:value-of select="DLHDon/NDHDon/NMua/Ten" /></b>
                                    </td>
                                </tr>
                                <tr style="mst_nguoi_mua_css_display;">
                                    <td style="padding-left:10px;mst_nguoi_mua_css;">
                                        Mã số thuế
                                        <i>(Tax code)</i>:
                                    
                                        <b><xsl:value-of select="DLHDon/NDHDon/NMua/MST" /></b>
                                    </td>
                                </tr>
                                <tr style="dia_chi_nguoi_mua_css_display;">
                                    <td style="padding-left:10px;dia_chi_nguoi_mua_css;">
                                        Địa chỉ
                                        <i>(Address)</i>:
                                ...
                                <tr style="so_tai_khoan_nguoi_mua_css_display;">
                                    <td style="padding-left:10px;so_tai_khoan_nguoi_mua_css;">
                                        Số tài khoản
                                        <i>(Account No)</i>:
...
<xsl:with-param name="text" select="THHDVu"/>
							...
							<div style="idparamTongtien">
								<table style="width: 100%; border-bottom: 1px solid black">
									<tr style="height: 30px; border-bottom: 1px solid black;border-left:1px solid black;border-right:1px solid black;font-size:10pt">
										...
										Cộng tiền bán hàng hóa, dịch vụ  <xsl:if test="DLHDon/NDHDon/TToan/TTKhac/TTin/DLieu!=''">( <xsl:value-of select="substring-after(substring-before(DLHDon/NDHDon/TToan/TTKhac/TTin/DLieu, substring-before(substring-after(DLHDon/NDHDon/TToan/TTKhac/TTin/DLieu,'giảm'),'tương')),'|')" /> &#160; <xsl:value-of select="format-number(substring-before(DLHDon/NDHDon/TToan/TTKhac/TTin/DLieu,'|'), '#.###','vnd')" /> đồng &#160; <xsl:value-of select="substring-after(DLHDon/NDHDon/TToan/TTKhac/TTin/DLieu, substring-before(substring-after(DLHDon/NDHDon/TToan/TTKhac/TTin/DLieu,'giảm'),'tương'))" />)</xsl:if>:
										</td>
										...
										<td style="width:10%;border-right: none!important;border-left: none;text-align:right">
											<b><xsl:value-of select="format-number(DLHDon/NDHDon/TToan/TgTTTBSo, '#.###','vnd')" /></b>
										</td>
									</tr>
								</table>
                      ...
                      Số tiền viết bằng chữ:
											<b><xsl:if test="DLHDon/NDHDon/TToan/TgTTTBSo  &lt; 0"><i>Âm </i></xsl:if>
											<xsl:variable name="AmountWord" select="DLHDon/NDHDon/TToan/TgTTTBChu"/>
											<xsl:value-of select="concat(translate(substring($AmountWord, 1, 1), 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'), substring($AmountWord,2,string-length($AmountWord)-1))"/></b>
										</td>
									</tr>
								</table>
