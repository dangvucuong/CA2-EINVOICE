        ...
        color:Black;
			...
			<body style="font-family:Times New Roman">
				...
				<!--<div style="viewstyle;width:100%">-->
					<div style="viewstyle;border:none;width:900px;margin:auto; border:2px solid black; padding-top:20px;z-index:1;background-image: url('https://hoadon78.nacencomm.vn/UploadIMG/bg/0103843548_a5qqfl4t.jpg'); background-size:44%; background-position: 50% 60%;width:900px;background-color: hsla(0,0%,100%,0.60);background-blend-mode: overlay;background-repeat:no-repeat;border:none;">
		  ...
		  MẪU
					...
					<table style="width:100%;color:#A52A2A">
						<tr >
							<td style="text-align:center;padding-left:0px!important;width:12%" rowspan="2" >
								<img style="height:80px;align-content:center;position:static;left:0;top:0;object-fit: scale-down;"
										  id="imgSample" src="paramLogo">
				</img>
							</td>
							<td  style="text-align:left;width:38%;font-size:11pt">
								...
								<br/>
								<!--    <span style="font-size:12.5pt">
				  <b> &#160;&#160; &#160;&#160;CHI NHÁNH CÔNG TY CỔ PHẦN </b>
				</span>
				<br/>
				<span>
				  <b> &#160;&#160; &#160;&#160;&#160;GIÁO DỤC VÀ DỊCH VỤ BÌNH MINH</b>
				</span>
				<br/> -->
								<span> Địa chỉ:
				...
				<span> &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Thành phố Hà Nội, Việt Nam </span> -->
				   ...
				   &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; Mã số thuế:
					 ...
					 <xsl:value-of select="inv:invoiceData/inv:sellerTaxCode" />
							...
							<td style="text-align:center; width:30%;">
								<span style="font-weight:bold; font-size:18pt">HÓA ĐƠN BÁN HÀNG</span>
								<br/>
				  ...
				  năm
							...
							<td style="width:20%;text-align:left;padding-left:20px;font-size:11pt">
...
8
  ...
  8
				...
				Họ và tên người nộp tiền:
							...
							<td style="border-bottom:1px dotted black;width:77%">
					...
					<xsl:choose>
						<xsl:when test="DLHDon/NDHDon/NMua/MST!=''">
						<table style="width:100%;color:#A52A2A;">
							<tr style="height:27px">
								<td style="padding-left:20px;width:15%">
					Mã số thuế:
			   ...
			   <td style="width:50%">
				...
				Thuế suất GTGT:
							...
							<td style="border-bottom:1px dotted black;width:34%">
									...
									<xsl:choose>
										...
										<xsl:otherwise>
											<xsl:choose>
												...
												<xsl:otherwise>
													<xsl:choose>
														<xsl:when test="TSuat='0%'"></xsl:when>
														<xsl:otherwise>
				...
				Tiền thuế GTGT:
							...
							<td style="border-bottom:1px dotted black;width:33%">
								<xsl:choose>
									<xsl:when test="TSuat='\'">
										<xsl:value-of select="'\'"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:choose>
											...
											<xsl:otherwise>
												<xsl:choose>
													<xsl:when test="DLHDon/NDHDon/TToan/TgTThue!=''"><xsl:value-of   select="format-number(DLHDon/NDHDon/TToan/TgTThue, '#.###','vnd')"/></xsl:when>
													<xsl:otherwise></xsl:otherwise>
												</xsl:choose>
					...
					<table style="width:100%;color:#A52A2A">
						<tr style="height:27px">
							<td style="padding-left:20px;width:27%">
								<b>Tổng số tiền phải thanh toán :</b>
							</td>
							<td style="border-bottom:1px dotted black;width:73%">
								<xsl:choose>
									<xsl:when test="DLHDon/NDHDon/TToan/TgTTTBSo!=''"><xsl:value-of   select="format-number(DLHDon/NDHDon/TToan/TgTTTBSo, '#.###','vnd')"/> đồng</xsl:when>
									<xsl:otherwise></xsl:otherwise>
								</xsl:choose>
					...
					<table style="width:100%;color:#A52A2A">
						<tr style="height: 27px; border-bottom: 1px none black">
							<td  style="padding-left:20px;border-left: none!important; border-right: none!important; text-align: left;width:15%">
								<i> Viết bằng chữ: </i>
							</td>
