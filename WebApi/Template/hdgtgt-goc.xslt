            ...
            <div size="A4" style="width:21cm;min-height:29.7cm;font-family:Times New Roman">
                <body style="font-family:Times New Roman">
                    <div style="viewstyle;border:none;">
                        ...
                        <div style="border:2px solid black;width:100%;height: auto; min-height: 100%;border-image:url(paramVien) 30 round;border-width:20px;z-index:1;border-color:white">
