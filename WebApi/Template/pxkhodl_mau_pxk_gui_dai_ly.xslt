...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
          ...
          letter-spacing: 5px;
            ...
            <body>
              ...
              <tr height="25px">
                ...
                <td style=" text-transform: uppercase;font-size:11pt;width:80%">
                  <b>

                    <xsl:value-of select="inv:invoiceData/inv:sellerLegalName" />
                ...
                <xsl:value-of select="inv:invoiceData/inv:sellerAddressLine" />
                        ...
                        <table style="width: 100%;">
                            <tr style="height:100px">
                                <td style="text-align:center; padding-left:0px!important;width:30%" rowspan="5"  >
                                    <img style="width:200px;height:100px;align-content:center;position:static;left:0;top:0px;object-fit: scale-down;" id="imgSample" src="paramLogo">
									</img>
                                </td>
                                <td style="text-align:center;width:40%">
                                    <div style="font-weight: bold; font-size: 18pt;width:100%;color:black;text-transform: uppercase">
                                    ...
                                    <div style="padding-top:5px;font-size:11pt" class="textfont">
                    Ngày
                                        <i>(Date)</i>&#160;
                      ...
                      năm
                                    ...
                                    <!--<div style="color: red; font-size: 9pt;padding-top:5px; display: normal;text-align:center">
                    <div style="display:none">
                      ...
                      TỪ HOÁ ĐƠN ĐIỆN TỬ
                                ...
                                <td style=" padding-left:10px;width:20%;font-size:12pt">
  ...
  7
                                    ...
                                    <div style="color: red; font-size: 10pt;padding-top:5px;  text-align:center">
                                        <div style="display: none;paramChuyendoi">
											HOÁ ĐƠN CHUYỂN ĐỔI
                                            <br />
											TỪ HOÁ ĐƠN ĐIỆN TỬ
                                        </div>
                        ...
                        <table style="width:100%;">
                            <tr>
                                <!--<td style="text-align:center; padding-top:10px;padding-left:0px!important;width:200px" rowspan="5" >
									<img style="width:200px;height:100px;align-content:center;position:static;left:0;top:0;object-fit: scale-down;"
															  id="imgSample" src="logo.png">
									</img>
								</td>-->
                                <td style="padding-left:10px;font-size:13pt">
                Tên người xuất hàng:
                                    <span style="font-weight:bold; font-size:17pt; color:black">
                                        <xsl:value-of select="DLHDon/NDHDon/NBan/Ten" />
                                    </span>
                                </td>
                            </tr>
                            <tr>
                                <td style="font-size:13pt; padding-left:10px;">
                            ...
                            <tr style="font-size:13pt;padding-left:10px;">
                                <td style="padding-left:10px;" >
									Theo lệnh điều động số:
                                    <span style="font-weight:bold"> &#160;&#160;&#160;
                            ...
                            <tr style="font-size:13pt;padding-left:10px;">
                                <td style="padding-left:10px;" >Tên người vận chuyển:
                            ...
                            <!-- <tr style="font-size:13pt;padding-left:10px;">
                                <td style="padding-left:10px;" >Họ tên người xuất hàng:  <xsl:value-of select="DLHDon/NDHDon/NBan/HVTNXHang" /> </td>
                            </tr>
                           
                             <tr style="font-size:13pt;padding-left:10px;">
                                <td style="padding-left:10px;" >Phương tiện vận chuyển:  <xsl:value-of select="DLHDon/NDHDon/NBan/PTVChuyen" /></td>
                            </tr> -->
                        </table>
                        <hr style="background-color: black; width: 100%; height: 2px;border:none" />
                        <table style="width: 100%;font-size:13pt;" class="textfont">
                            ...
                            <tr>
                                <td style="padding-left:10px;">Địa điểm nhận hàng:
                                    <xsl:value-of select="DLHDon/NDHDon/NMua/DChi" />
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-left:10px;">Mã số thuế:
                                    <xsl:value-of select="DLHDon/NDHDon/NMua/MST" />
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-left:10px;">Xuất tại kho:
                                    <xsl:choose>
                                        <xsl:when test="contains(.,'|')">
                            ...
                            <tr>
                                <td style="padding-left:10px;">Đơn vị tiền tệ:
                        ...
                        <table style="width:100%;text-align:center; border: 1px solid black;font-size:12pt;height:30px;" >
                            <tr>
                                <th style="border: 1px solid black;text-align:center;" width="5%" rowspan="2">STT</th>
                                <th style="border: 1px solid black;text-align:center;" rowspan="2">Tên nhãn hiệu, quy cách, phẩm chất vật tư
                                    <br/>(sản phẩm, hàng hóa)
                                </th>
                                <!-- <th style="border: 1px solid black;text-align:center;" width="20%" rowspan="2">Mã số</th> -->
                                <th style="border: 1px solid black;text-align:center;" width="10%" rowspan="2">Đơn vị
                                    <br/>tính
                                </th>
                                <th style="border: 1px solid black;text-align:center;" width="10%" colspan="2">Số lượng</th>
                            ...
                            <!-- <tr>
            <th style="border: 1px solid black;text-align:center;" width="5%">Thực xuất</th>
            <th style="border: 1px solid black;text-align:center;" width="5%">Thực nhập</th>
        </tr> -->
                        </table>
                        <table style="width:100%;text-align:center; font-size:12pt;border: 1px solid black;;">
                        ...
                        <table style="width: 100%; border-top: none;font-size:13pt" class="textfont">
                            <tr>
                  ...
                  (Ký, ghi rõ họ tên)
                            ...
                            <tr>
                                ...
                                <td style="border: none; padding-top: 2px; text-align: center;">
