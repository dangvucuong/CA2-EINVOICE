                ...
                <body style="font-family:Times New Roman">
                    ...
                    Số tài khoản
                                    ...
                                    <td>
                                       201.220.135.2160
                    Tại:
                                       Ngân hàng Agribank KCN Đà Nẵng
                                    </td>
                                </tr>
                                                ...
                                                <xsl:when test="count(DLHDon/NDHDon/DSHHDVu/HHDVu) &lt; 11" >
                                                    <xsl:for-each select="DLHDon/NDHDon/DSHHDVu/HHDVu">
                                                        <tr style="height:25px;border-top: none!important;border-bottom:1px dotted gray;">
                                                            ...
                                                            <td style="width:30%;text-align:left;border-right:1px solid black;padding-left:3px;word-break:break-word;white-space: normal;line-height: 1.4;">
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$soHHdu &gt; 0">
                                            <!-- <xsl:for-each select="(//node())[$soHHdu >= position()]">
                                                 ...
                                                 <td style="width:30%;text-align:left;border-right:1px solid black;padding-left:3px;word-break:break-word;white-space: normal;line-height: 1.4;"></td>
