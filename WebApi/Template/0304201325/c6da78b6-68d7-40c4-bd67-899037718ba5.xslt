...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
						...
						<table style="width:100%;line-height:25px;font-size:10pt;color:black">
							...
							<tr>
								...
								<td>
									...
									<xsl:if test="DLHDon/TTChung/TGia !='0'">
										Tỷ giá:
										<span style="color:black;font-size:10pt;">
  ...
  7
      ...
      string-length(concat('0000000', DLHDon/TTChung/TTHDLQuan/SHDCLQuan)) - 6
									...
									<xsl:value-of select="substring(DLHDon/TTChung/TTHDLQuan/NLHDCLQuan,9,2)"/> tháng
									<xsl:value-of select="substring(DLHDon/TTChung/TTHDLQuan/NLHDCLQuan,6,2)"/> năm
									<xsl:value-of select="substring(DLHDon/TTChung/TTHDLQuan/NLHDCLQuan,1,4)"/>
								</div>
							</xsl:when>
							<xsl:otherwise>
								...
								<table style="width: 100%; border-bottom: 1px solid black">
									<tr style="height: 30px; border-bottom: 1px solid black;border-left:1px solid black;border-right:1px solid black;font-size:10pt">
										<td style="border-left: none!important; border-right: none;padding-left:10px;">
											Cộng tiền bán hàng hóa, dịch vụ  <xsl:if test="DLHDon/NDHDon/TToan/TTKhac/TTin/DLieu!=''">
												( <xsl:value-of select="substring-after(substring-before(DLHDon/NDHDon/TToan/TTKhac/TTin/DLieu, substring-before(substring-after(DLHDon/NDHDon/TToan/TTKhac/TTin/DLieu,'giảm'),'tương')),'|')" /> &#160; <xsl:value-of select="format-number(substring-before(DLHDon/NDHDon/TToan/TTKhac/TTin/DLieu,'|'), '#.###','vnd')" /> đồng &#160; <xsl:value-of select="substring-after(DLHDon/NDHDon/TToan/TTKhac/TTin/DLieu, substring-before(substring-after(DLHDon/NDHDon/TToan/TTKhac/TTin/DLieu,'giảm'),'tương'))" />)
											</xsl:if>:
										</td>
					...
					<div style="width:100%;padding-top:0px;text-align:center;padding-bottom:1px;font-size:9.5pt">
						<span>
							<i>Tra cứu hóa đơn tại địa chỉ trang web: https://ca2einv.nacencomm.vn </i>&#160;&#160;&#160;&#160;Mã tra cứu: <b>
