...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="HDon">
        ...
        <xsl:variable name="countItems" select="count(DLHDon/NDHDon/DSHHDVu/HHDVu/STT)" />

<xsl:variable name="soHHdu">
    <xsl:choose>
        <xsl:when test="$countItems = 1">8</xsl:when>
        <xsl:otherwise>
            <xsl:value-of select="10 - $countItems"/>
        </xsl:otherwise>
    </xsl:choose>
</xsl:variable>
                        ...
                        <div style="border:2px solid black;width:100%;height: auto; min-height: 100%;background-image:url(paramVien);
                            ...
                            <div id="header" style="display:flex;flex-direction:paramOpacityHeaderFlexDirection;padding-top:10px;padding-right:10px">
                                ...
                                <div id="header_center" style="flex:1;text-align:center">
                                    ...
                                    <br/>
                                    <span style="font-weight:bold; font-size:15pt;font-style:italic">(VAT INVOICE)</span>
                                    <br/>
                            ...
                            <table style="width:100%;line-height:25px;font-size:12pt">
                                <tr style="ten_cong_ty_css_display;">
                                    ...
                                    <td style="padding-left:0px;ten_cong_ty_css;" colspan="2">
                                        ...
                                        <xsl:value-of select="DLHDon/NDHDon/NBan/Ten" /></span>
                                        <!-- </div> -->
                                        <!-- <br/> -->
                                    </td>
                                </tr>
                            ...
                            <div style="background:url('paramWaterMarkTable;');background-color: hsla(0,0%,100%,paramOpacity;);background-blend-mode: overlay;">
                                <table style="width:100%;text-align:center; font-size:12pt;border-top: 1px solid black;border-bottom:1px solid black;border-left:1px solid black;border-right:none;" >
                                    <tr style="height:25px;">
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$somucthue &gt; 1"> <td width="7%" style="border: 1px solid black">
                                            <span style="font-size: 12pt">
                                                <b>
                                                    Thuế suất GTGT(%)
                                                    <br/>
                                                    ...
                                                    <xsl:for-each select="DLHDon/NDHDon/DSHHDVu/HHDVu">
                                                        <tr style="height:25px;border-top: none!important;border-bottom:1px dotted gray;">
                                                            ...
                                                            <td style="width:30%;text-align:left;border-right:1px solid black;padding-left:3px">
                                                                <xsl:call-template name="split">                                                        <xsl:with-param name="text" select="THHDVu"/>                                                        </xsl:call-template>
                                                            </td>
    ...
    <xsl:when test="$soHHdu &gt; 0">
        <xsl:for-each select="(//node())[$soHHdu >= position()]">
            <tr style="height:25px;border-top: none!important;border-bottom:1px dotted gray;">
                ...
                <xsl:choose>
                    <xsl:when test="$somucthue &gt; 1">
                        <td width="7%" style="border-right: 1px solid black;text-align:right;padding-right:5px"></td>
                    </xsl:when>
                    <xsl:otherwise></xsl:otherwise>
                </xsl:choose>
            </tr>
    ...
    <xsl:otherwise></xsl:otherwise>
                            ...
                            <div style="width:100%;display:paramfooter">
                                <div style="idparamTongtien">
                                    <xsl:if test="DLHDon/NDHDon/TToan/DSLPhi/LPhi">
                                     ...
                                     <xsl:choose>
                                        <xsl:when test="$somucthue &gt; 1">
                                            <table style="width:100%;text-align:left;border-left:1px solid black;border-top:1px solid black;border-right:1px solid black;font-size:12pt;color:black ">
                                                ...
                                                <xsl:if test="DLHDon/NDHDon/TToan/TTCKTMai!='0'">
                                                 <tr style="border:1px solid black">
                                        ...
                                        <xsl:otherwise>
                                            <table style="width: 100%; border: 1px solid black;font-size:12pt;color:black" class="textfont">
                                            ...
                                            <table style="width: 100%; border-left: 1px solid black;border-right: 1px solid black;font-size:12pt;color:black" class="textfont">
                                                <tr style="height: 30px; border-bottom: 1px solid black">
                     ...
                     Tổng cộng tiền thanh toán
                            ...
                            <table style="width: 100%;border-top:1px solid black;font-size:12pt;display:paramfooter" class="textfont">
                                ...
                                <tr>
                                    <td colspan="3" style="text-align: center; border: none; padding-top: 1px;padding-bottom:2px">
