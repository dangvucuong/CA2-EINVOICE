                ...
                <body style="font-family:Times New Roman">
                    ...
                    <div style="viewstyle;border:none;">
                        ...
                        <div id="background" style="paramdisable">
                            <span style="margin-top:50px">contentDisable</span>
                        </div>
                                                ...
                                                <xsl:when test="count(DLHDon/NDHDon/DSHHDVu/HHDVu) &lt; 11" >
                                                    <xsl:for-each select="DLHDon/NDHDon/DSHHDVu/HHDVu">
                                                        <tr style="height:25px;border-top: none!important;border-bottom:1px dotted gray;">
                                                            ...
                                                            <td width="8%" style="text-align:center;border-right:1px solid black">
                                                                <xsl:choose>
                                                            ...
                                                            <td width="10%" style="border-right:1px solid black!important;text-align:right">
                                                                <xsl:value-of select="format-number(ThTien, '#.###','vnd')" />
                                                            </td>
                                                            <xsl:choose>
                                                                <xsl:when test="$somucthue &gt; 0">
                                                                    <td style="border-right: 1px solid black;text-align:right;padding-right:5px" width="8%">
                                                                        <xsl:choose>
                                                                            <xsl:when test="TChat!=4">
                                                            ...
                                                            <td width="8%" style="border-right:1px solid black;text-align:right">
                                                                <xsl:if test="TSuat='10%'">
                                                                    <xsl:value-of select="format-number(ThTien*0.1, '#.###','vnd')" />
                                                                </xsl:if>
                                                                <xsl:if test="TSuat='8%'">
                                                                    <xsl:value-of select="format-number(ThTien*0.08, '#.###','vnd')" />
                                                                </xsl:if>
                                                                <xsl:if test="TSuat='5%'">
                                                                    <xsl:value-of select="format-number(ThTien*0.05, '#.###','vnd')" />
                                                                </xsl:if>
                                                                <xsl:if test="TSuat='0%'">
                                                            ...
                                                            <td width="10%" style="border-right:1px solid #1A4780;text-align:right">
                                                                <xsl:if test="TSuat='10%'">
                                                                    <xsl:value-of select="format-number(ThTien + (ThTien*0.1), '#.###','vnd')" />
                                                                </xsl:if>
                                                                <xsl:if test="TSuat='8%'">
                                                                    <xsl:value-of select="format-number(ThTien + (ThTien*0.08), '#.###','vnd')" />
                                                                </xsl:if>
                                                                <xsl:if test="TSuat='5%'">
                                                                    <xsl:value-of select="format-number(ThTien + (ThTien*0.05), '#.###','vnd')" />
                                                                </xsl:if>
                                                                <xsl:if test="TSuat='0%'">
                                                                    <xsl:value-of select="format-number(ThTien, '#.###','vnd')" />
                                                                </xsl:if>
                                                ...
                                                <tr style="height:25px;border-top: none!important;border-bottom:1px dotted gray;">
                                                    ...
                                                    <xsl:if test="$TTCKTMai !=0">
                                                        <td width="10%" style="text-align:right;border-right:1px solid black">
                                                            ...
                                                            <xsl:if test="STCKhau &gt; 0 and TLCKhau=0"><xsl:value-of select="format-number(STCKhau, '#.###,##','vnd')" /></xsl:if>
                                                             <xsl:if test="STCKhau &gt; 0 and TLCKhau &gt; 0"><xsl:value-of select="format-number(STCKhau, '#.###,##','vnd')" /></xsl:if>
                                                          <!-- <xsl:if test="DLHDon/NDHDon/DSHHDVu/HHDVu[TLCKhau &gt; 0 and STCKhau = 0]">
    <xsl:value-of select="DLHDon/NDHDon/DSHHDVu/HHDVu/TLCKhau" />%
</xsl:if> -->
                                                                            <!-- <xsl:if test="DLHDon/NDHDon/DSHHDVu/HHDVu/STCKhau &gt; 0 and DLHDon/NDHDon/DSHHDVu/HHDVu/TLCKhau=0"><xsl:value-of select="format-number(DLHDon/NDHDon/DSHHDVu/HHDVu/STCKhau, '#.###,##','vnd')" /></xsl:if>
                                        ...
                                        <xsl:when test="$soHHdu &gt; 0">
                                            <xsl:for-each select="(//node())[$soHHdu >= position()]">
                                                <tr style="height:25px;border-top: none!important;border-bottom:1px dotted gray;">
                                                    ...
                                                    <td width="8%" style="text-align:center;border-right:1px solid black"></td>
                                                    <td width="8%" style="text-align:center;border-right:1px solid black"></td>
                                                    ...
                                                    <xsl:choose>
                                                        <xsl:when test="$somucthue &gt; 0">
                                                            <td style="border-right: 1px solid black;text-align:right;padding-right:5px" width="8%"></td>
                                                        </xsl:when>
                                                        <xsl:otherwise></xsl:otherwise>
                                                    </xsl:choose>
                            ...
                            <div style="width:100%;display:paramfooter">
                                <div style="idparamTongtien">
                                    ...
                                    <table style="width:100%;text-align:center; font-size:12pt;border-top: 1px solid black;border-bottom:1px solid black;border-left:1px solid black;border-right:1px solid black;" >
                                        <tr>
                                            <th style="text-align:center;border: 1px solid black">Tổng hợp</th>
                                            <th style="text-align:center;border: 1px solid black">Thành tiền trước thuế</th>
                                            <th style="text-align:center;border: 1px solid black">Tiền thuế GTGT</th>
                                            <xsl:choose>
                                                <xsl:when test="$TTCKTMai !=0"><th style="text-align:center;border: 1px solid black">Tổng chiết khấu thương mại</th></xsl:when>
                                                <xsl:otherwise></xsl:otherwise>
                                            </xsl:choose>
                                            <th style="text-align:center;border: 1px solid black">Cộng tiền thanh toán</th>
                                        ...
                                        <tr style="border:1px solid black">
                                            ...
                                            <td style="border-right:1px solid black;text-align:right">
                                             ...
                                             <xsl:choose>
                                                    <xsl:when test="$TTCKTMai!='0'"><td style="border-right:1px solid black;text-align:right">
