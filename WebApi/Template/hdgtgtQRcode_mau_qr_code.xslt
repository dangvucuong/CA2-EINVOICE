  ...
  8
                  ...
                  Đơn vị bán hàng
                                    ...
                                    <td style="padding-left:0px;">
                                        <span style="font-weight:bold; font-size:12pt;text-transform: uppercase;">
                    ...
                    Mã số thuế
                                ...
                                <table style="width:100%;line-height:25px">
                                <tr>
                                    <td style="padding-left:20px;width:22%">
                    Địa chỉ
                                        <i>(Address)</i>:
                                    </td>
                                    <td style="width:78%">
                    ...
                    Điện thoại
                            ...
                            <table style="width:100%;line-height:25px">
                                <tr>
                                    <td style="padding-left:20px;width:32%">
                    Họ tên người mua
                                        <i>(Customer Name)</i>:
                                    </td>
                                    <td style="width:68%">
                    ...
                    Số điện thoại
                                        <i>(Tel)</i>:
                                        <xsl:value-of select="DLHDon/NDHDon/NMua/SDThoai" /> &#160;&#160;<xsl:if test="DLHDon/NDHDon/NMua/DCTDTu!=''">Email
                                    :
                                        <xsl:value-of select="DLHDon/NDHDon/NMua/DCTDTu" /></xsl:if>  -->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <xsl:if test="DLHDon/TTChung/TGia !=''">Tỷ giá:
                                            <xsl:value-of select="format-number(DLHDon/TTChung/TGia, '###.##0,#######','number')" />
                                        </xsl:if>
                                    </td>
                                </tr>
                            </table>
...
Hoa don chua phat hanh
                                                ...
                                                <xsl:for-each select="DLHDon/NDHDon/DSHHDVu/HHDVu">
                                                    <tr style="height:25px;border-top: none!important;border-bottom:1px dotted gray;">
                                                        ...
                                                        <td width="13%" style="border-right:1px solid black!important;text-align:right">
                                                            <xsl:value-of select="format-number(ThTien, '###.##0,#######','number')" />
                                                        </td>
                                                        <xsl:choose>
                                                            <xsl:when test="$somucthue &gt; 1">
          ...
          Tổng thuế
                                                            ...
                                                            <td  style="border-bottom: 1px solid black; border-right: 1px solid black;text-align:right ">
                                                                <xsl:value-of   select="format-number(TThue, '###.##0,#######','number')"/>
        ...
        Total trade discount amount)</i>
                                                            ...
                                                            <td style="border-bottom: 1px solid black; border-right: 1px solid black;text-align:right ">
                                                                <xsl:value-of   select="format-number(TTCKTMai, '###.##0,#######','number')"/>
                                                            </td>
                                                        </tr>
                                                    </xsl:if>
                                                        ...
                                                        <tr style="height:25px;border-top: none!important;border-bottom:1px dotted gray;">
                                                            ...
                                                            <td style="border-bottom: 1px solid black; border-right: 1px solid black;text-align:right ">
                                                                <b>
                                                                    <xsl:value-of   select="format-number(TgTTTBSo, '###.##0,#######','number')"/>
                                                                </b>
                                                            </td>
                                                        </tr>
                                                ...
                                                <xsl:when test="DLHDon/NDHDon/TToan/TTCKTMai!=''">
                                                    <table style="width: 100%; border-left: 1px solid black;border-right: 1px solid black" class="textfont">
                                                        <tr style="height: 30px; border-bottom: 1px solid black">
                                                            ...
                                                            <td style="width:45%;border-left: none!important; border-right: none;text-align:right">
              ...
              Giải pháp hóa đơn điện tử được cung cấp bởi:
                        ...
                        <xsl:choose>
                            <xsl:when test="DLHDon/TTChung/TTKhac/TTin/TTruong='MTCuu'"></xsl:when>
                            <xsl:otherwise> <div style="width:100%;padding-top:3px;text-align:center;padding-bottom:0px;">
                  ...
                  Chuỗi xác thực
                                    ...
                                    <b >
                                     ...
                                     <!-- <xsl:if test="$MTCuu!=''">&#160;&#160; &#160;&#160; &#160;&#160; &#160;&#160;Mã tra cứu: <b><xsl:value-of select="$MTCuu" /></b> </xsl:if> -->
                                </span>
                            </div></xsl:otherwise>
                        </xsl:choose>
              ...
              Giải pháp hóa đơn điện tử được cung cấp bởi:
                        ...
                        <div style="width:100%;padding-top:0px;text-align:center;padding-bottom:1px;">
                            <span>
                                <i>Tra cứu hóa đơn tại địa chỉ trang web: https://hoadon78.nacencomm.vn <xsl:if test="DLHDon/TTChung/TTKhac/TTin/TTruong='MTCuu'">&#160;&#160;&#160;&#160;Mã tra cứu: <b><xsl:value-of select="DLHDon/TTChung/TTKhac/TTin/DLieu" /></b></xsl:if></i>
                            </span>
                        </div>
                        <xsl:variable name="lien" select="paramlien" />
                        <xsl:choose>
