...
line-height: 1.7;
            ...
            <body style="font-family:Times New Roman; font-size: 13pt;line-height: 28px;">
                <!--<div style="width:900px;margin:auto; border:2px solid black; padding-top:20px;z-index:1;background-image: url(''); background-size:80%; background-position: center;background-repeat:no-repeat;width:100%">-->
                <div style="width:900px;margin:auto; border:2px solid black; padding-top:20px;z-index:1;background-image: url(''); background-size:80%; background-position: center;background-repeat:no-repeat;border:none;    background-size: 100%; background-color: hsla(0,0%,100%,0.60);background-position: 50% 56%!important;">
                    <div id="background" style="position:absolute;z-index:0;width:300px;height:140px;border:5px solid red;background:transparent;display:block;top:45%;left:40%;color:red;font-size:70pt;text-align:center;padding-top:10px;">
              MẪU
            </div>
                    <div id="background" style="position:absolute;z-index:0;width:300px;height:140px;border:5px solid red;background:transparent;display:none;top:45%;left:40%;color:red;font-size:70pt;text-align:center;padding-top:10px;;width: 190px;height: 125px;top:50%;font-size: 60pt">&#160;</div>
                    ...
                    Số :
                        ...
                        <table width="100%" style="font-weight:bold;line-height: 28px;">
                            <tr>
                                <td align="center">
                                    ...
                                    <br />
                                    <span style="font-size:10.5pt"> Ngày
                                            &#160;
                                        ...
                                        <xsl:variable name="string1">
                                            <xsl:value-of select="substring(DLCTu/TTChung/NLap,6,2)" />
                                        </xsl:variable>
                                        <xsl:value-of select="$string1" /> năm
                                            &#160;
                                        <xsl:variable name="string2">
                                            <xsl:value-of select="substring(DLCTu/TTChung/NLap,1,4)" />
                                        </xsl:variable>
                        ...
                        <table style="width:100%;line-height: 28px">
                            <tr>
                                <td colspan="2" style="display: flex; align-items: bottom;padding-left:20px;">
                                    <span>[1] Tên tổ chức trả thu nhập :</span>
                        ...
                        <table style="width:100%;line-height: 28px">
                            <tr>
                                ...
                                <td style="padding-left:20px;width:40%">
                                    <xsl:choose>
                                        <xsl:when test="DLCTu/NDCTu/NNT/CNCTru=1">  [8] Cá nhân cư trú :
                                            <input type="checkbox" checked="checked" />
                                        </xsl:when>
                                        <xsl:otherwise>  [8] Cá nhân cư trú :
                                            <input type="checkbox" />
                                        </xsl:otherwise>
                                    </xsl:choose>&#160;&#160;&#160;&#160;
                                    <xsl:choose>
                                        <xsl:when test="DLCTu/NDCTu/NNT/CNCTru=0"> [9] Cá nhân không cư trú :
                                            <input type="checkbox" checked="checked" />
                                        </xsl:when>
                                        <xsl:otherwise>  [9] Cá nhân không cư trú :
                                        </xsl:otherwise>
                                    </xsl:choose>
                                </td>
                            </tr>
                        ...
                        <table style="width:100%;line-height: 28px;">
                            <tr>
                                <td width="60%">
                                    <div style="width:100%;text-align:center;width:100%;text-align:center;display:normal">
                  Người chuyển đổi
                                        <br />
                  (Ký, ghi rõ họ tên)
                                    </div>
                    ...
                    Ngày ký:
                                            ...
                                            <xsl:value-of select="substring( //*[local-name() = 'SigningTime'],12,8)"/>
                                        </span>
                                    </div>
                                </td>
                            </tr>
