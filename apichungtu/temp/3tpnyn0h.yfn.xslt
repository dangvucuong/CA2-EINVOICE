                        ...
                        <xsl:choose>
                            <xsl:when test="$lien &gt; 1">
                                <div style="text-align:center;padding-top:0px">
                                    ...
                                    <span style="text-align:center;padding-top:3px"> Trang  </span>
                                </div>
                            </xsl:when>
                            <xsl:otherwise>
